    ...
    return (
      <div className="daily-header">
        <div className="daily-header-description">
          For a period of a year I will make <strong>one sketch a day</strong>, each sketch takes
          around 30 minutes. <br />
          The works in this page are quick sketches, if you want to see my work projects head over to <Link to="/projects">projects</Link> <br />
        </div>
        ...
        <div className="daily-header-callout">
          ...
          {callout.map((item, i) => (
            <div className="daily-header-callout-item" key={`daily-header-item-${i}`}>
              <div className="daily-header-callout-item-number">
                {item.number}
              </div>

              <div className="daily-header-callout-item-title">
                {item.title}
              </div>
